...
export const COMMAND_MANIFEST: CommandManifestEntry[] = [
	...
	{
		command: "settings 2fa",
		transport: "http",
		endpoint: "GET|POST /api/cli/settings/two-factor/*",
		machineOutput: true,
	},
	{
		command: "settings ip-allowlist",
		transport: "http",
		endpoint: "GET|PUT /api/cli/settings/ip-allowlist",
		machineOutput: true,
	},
	{
		command: "settings retention",
		transport: "http",
		endpoint: "GET|PUT /api/cli/settings/retention",
		machineOutput: true,
	},
	{
		command: "settings sso",
		transport: "http",
		endpoint: "GET /api/cli/settings/sso",
		machineOutput: true,
	},
	{
		command: "admin audit-log",
		transport: "http",
		endpoint: "GET /api/cli/admin/audit-log",
		machineOutput: true,
	},
	{
		command: "admin feature-flags",
		transport: "http",
		endpoint: "GET /api/cli/admin/feature-flags",
		machineOutput: true,
	},
	{
		command: "breach advisories",
		transport: "http",
		endpoint: "GET /api/cli/breach/advisories",
		machineOutput: true,
	},
	{
		command: "breach sync",
		transport: "http",
		endpoint: "POST /api/cli/breach/sync",
		machineOutput: true,
	},
	{
