...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.ssoProviderDriftIntel.getLatestSsoProviderDrift>
>;
...
export default function RepositorySsoProviderDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">SSO Provider Drift</h3>
