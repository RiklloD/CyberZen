...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.secretMgmtDriftIntel.getLatestSecretMgmtDrift>
>;
...
export default function RepositorySecretMgmtDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Secret Management Drift</h3>
