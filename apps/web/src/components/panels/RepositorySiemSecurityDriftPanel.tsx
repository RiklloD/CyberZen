...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.siemSecurityDriftIntel.getLatestSiemSecurityDrift>
>;
...
export default function RepositorySiemSecurityDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">SIEM Security Drift</h3>
