...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.backupDrSecurityDriftIntel.getLatestBackupDrSecurityDrift>
>;
...
export default function RepositoryBackupDrSecurityDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Backup/DR Security Drift</h3>
