...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.dataPipelineDriftIntel.getLatestDataPipelineDrift>
>;
...
export default function RepositoryDataPipelineDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Data Pipeline Drift</h3>
