...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.apiSecurityDriftIntel.getLatestApiSecurityDrift>
>;
...
export default function RepositoryApiSecurityDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">API Security Drift</h3>
