...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.cicdPipelineSecurityDriftIntel.getLatestCicdPipelineSecurityDrift>
>;
...
export default function RepositoryCicdPipelineSecurityDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">CI/CD Pipeline Security Drift</h3>
