...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.networkFirewallDriftIntel.getLatestNetworkFirewallDrift>
>;
...
export default function RepositoryNetworkFirewallDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Network Firewall Drift</h3>
