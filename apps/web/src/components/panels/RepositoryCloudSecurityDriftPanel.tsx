...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.cloudSecurityDriftIntel.getLatestCloudSecurityDrift>
>;
...
export default function RepositoryCloudSecurityDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Cloud Security Drift</h3>
