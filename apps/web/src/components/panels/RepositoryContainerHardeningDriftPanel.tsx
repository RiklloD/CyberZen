...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.containerHardeningDriftIntel.getLatestContainerHardeningDrift>
>;
...
export default function RepositoryContainerHardeningDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Container Hardening Drift</h3>
