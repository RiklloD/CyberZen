...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.k8sAdmissionDriftIntel.getLatestK8sAdmissionDrift>
>;
...
export default function RepositoryK8sAdmissionDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Kubernetes Admission Drift</h3>
