...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.depMgrSecurityDriftIntel.getLatestDepMgrSecurityDrift>
>;
...
export default function RepositoryDepMgrSecurityDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Dependency Manager Security Drift</h3>
