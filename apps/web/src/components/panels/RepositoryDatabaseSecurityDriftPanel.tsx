...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.databaseSecurityDriftIntel.getLatestDatabaseSecurityDrift>
>;
...
export default function RepositoryDatabaseSecurityDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Database Security Drift</h3>
