...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.emailSecurityDriftIntel.getLatestEmailSecurityDrift>
>;
...
export default function RepositoryEmailSecurityDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Email Security Drift</h3>
