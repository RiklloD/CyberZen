...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.vpnRemoteAccessDriftIntel.getLatestVpnRemoteAccessDrift>
>;
...
export default function RepositoryVpnRemoteAccessDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">VPN/Remote Access Drift</h3>
