...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.webServerSecurityDriftIntel.getLatestWebServerSecurityDrift>
>;
...
export default function RepositoryWebServerSecurityDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Web Server Security Drift</h3>
