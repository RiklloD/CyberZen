...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.certPkiDriftIntel.getLatestCertPkiDrift>
>;
...
export default function RepositoryCertPkiDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Certificate/PKI Drift</h3>
