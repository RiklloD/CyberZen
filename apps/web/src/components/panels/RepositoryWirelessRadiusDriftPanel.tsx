...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.wirelessRadiusDriftIntel.getLatestWirelessRadiusDrift>
>;
...
export default function RepositoryWirelessRadiusDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Wireless/RADIUS Drift</h3>
