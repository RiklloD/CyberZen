...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.networkMonitoringDriftIntel.getLatestNetworkMonitoringDrift>
>;
...
export default function RepositoryNetworkMonitoringDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Network Monitoring Drift</h3>
