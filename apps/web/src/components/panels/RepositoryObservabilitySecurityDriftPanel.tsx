...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.observabilitySecurityDriftIntel.getLatestObservabilitySecurityDrift>
>;
...
export default function RepositoryObservabilitySecurityDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Observability Security Drift</h3>
