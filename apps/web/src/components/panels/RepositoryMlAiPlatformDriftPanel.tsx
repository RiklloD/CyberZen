...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.mlAiPlatformDriftIntel.getLatestMlAiPlatformDrift>
>;
...
export default function RepositoryMlAiPlatformDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">ML/AI Platform Drift</h3>
