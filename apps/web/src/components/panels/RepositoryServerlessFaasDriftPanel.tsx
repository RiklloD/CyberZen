...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.serverlessFaasDriftIntel.getLatestServerlessFaasDrift>
>;
...
export default function RepositoryServerlessFaasDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Serverless/FaaS Drift</h3>
