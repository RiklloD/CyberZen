...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.runtimeSecurityDriftIntel.getLatestRuntimeSecurityDrift>
>;
...
export default function RepositoryRuntimeSecurityDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Runtime Security Drift</h3>
