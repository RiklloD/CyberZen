...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.iotEmbeddedSecurityDriftIntel.getLatestIotEmbeddedSecurityDrift>
>;
...
export default function RepositoryIotEmbeddedSecurityDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">IoT/Embedded Security Drift</h3>
