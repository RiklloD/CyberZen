...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.virtualizationSecurityDriftIntel.getLatestVirtualizationSecurityDrift>
>;
...
export default function RepositoryVirtualizationSecurityDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Virtualization Security Drift</h3>
