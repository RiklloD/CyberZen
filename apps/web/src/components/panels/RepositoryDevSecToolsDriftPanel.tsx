...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.devSecToolsDriftIntel.getLatestDevSecToolsDrift>
>;
...
export default function RepositoryDevSecToolsDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">DevSec Tools Drift</h3>
