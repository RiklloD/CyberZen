...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.cfgMgmtSecurityDriftIntel.getLatestCfgMgmtSecurityDrift>
>;
...
export default function RepositoryCfgMgmtSecurityDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Config Management Security Drift</h3>
