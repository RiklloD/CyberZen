...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.aiMlSecurityDriftIntel.getLatestAiMlSecurityDrift>
>;
...
export default function RepositoryAiMlSecurityDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">AI/ML Security Drift</h3>
