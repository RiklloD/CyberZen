...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.identityAccessDriftIntel.getLatestIdentityAccessDrift>
>;
...
export default function RepositoryIdentityAccessDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Identity & Access Drift</h3>
