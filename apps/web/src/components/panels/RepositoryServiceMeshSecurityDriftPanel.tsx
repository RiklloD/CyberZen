...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.serviceMeshSecurityDriftIntel.getLatestServiceMeshSecurityDrift>
>;
...
export default function RepositoryServiceMeshSecurityDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Service Mesh Security Drift</h3>
