...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.osSecurityHardeningDriftIntel.getLatestOsSecurityHardeningDrift>
>;
...
export default function RepositoryOsSecurityHardeningDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">OS Security Hardening Drift</h3>
