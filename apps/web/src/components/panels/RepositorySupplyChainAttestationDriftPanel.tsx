...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.supplyChainAttestationDriftIntel.getLatestSupplyChainAttestationDrift>
>;
...
export default function RepositorySupplyChainAttestationDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Supply Chain Attestation Drift</h3>
