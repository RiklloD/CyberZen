...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.voipSecurityDriftIntel.getLatestVoipSecurityDrift>
>;
...
export default function RepositoryVoipSecurityDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">VoIP Security Drift</h3>
