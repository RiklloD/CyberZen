...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.storageDataSecurityDriftIntel.getLatestStorageDataSecurityDrift>
>;
...
export default function RepositoryStorageDataSecurityDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Storage/Data Security Drift</h3>
