...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.securityConfigDriftIntel.getLatestSecurityConfigDrift>
>;
...
export default function RepositorySecurityConfigDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Security Config Drift</h3>
