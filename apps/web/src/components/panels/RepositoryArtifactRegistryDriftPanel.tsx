...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.artifactRegistryDriftIntel.getLatestArtifactRegistryDrift>
>;
...
export default function RepositoryArtifactRegistryDriftPanel({
  data }: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Artifact Registry Drift</h3>
