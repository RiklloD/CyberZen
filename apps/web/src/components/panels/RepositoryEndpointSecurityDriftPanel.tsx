...
type ScanDoc = NonNullable<
  FunctionReturnType<typeof api.endpointSecurityDriftIntel.getLatestEndpointSecurityDrift>
>;
...
export default function RepositoryEndpointSecurityDriftPanel({
  data,
}: {
  data: ScanDoc;
}) {
    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="section-title">Endpoint Security Drift</h3>
