...
import { v as resolveManifestAssetLink, w as rootRouteId, x as getNormalizedURL, y as getOrigin, z as attachRouterServerSsrUtils, A as defineHandlerCallback, C as createSerializationAdapter, D as createRawStreamRPCPlugin, E as invariant, F as isNotFound, G as isRedirect, H as isResolvedRedirect, I as mergeHeaders, J as executeRewriteInput, K as defaultSerovalPlugins, L as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DfSE2VLG.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-XsWVnAhB.mjs").then((n) => n.r),
